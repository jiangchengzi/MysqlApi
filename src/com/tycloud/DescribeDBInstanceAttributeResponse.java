 ...
 * @author houge
 */
public class DescribeDBInstanceAttributeResponse extends TyResponse {
    ...
    public static class DBInstanceAttribute {
        ...
        public void setSupportUpgradeAccountType(
        ...
        public enum SupportUpgradeAccountType {
            ...
            public static SupportUpgradeAccountType getEnum(String stringValue) {
                ...
                for (SupportUpgradeAccountType supportUpgradeAccountType : SupportUpgradeAccountType
                        .values()) {
    ...
    @Override
    public DescribeDBInstanceAttributeResponse getInstance(MarshallerContext context) {
        return DescribeDBInstanceAttributeResponseMarshaller.marshall(this, context);
    }
}
