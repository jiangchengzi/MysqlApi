 ...
 * @author houge
 */
public class DescribeDBInstancesResponse extends TyResponse {
    ...
    @Override
    public DescribeDBInstancesResponse getInstance(MarshallerContext context) {
        return DescribeDBInstancesResponseMarshaller.marshall(this, context);
    }
}
